        ...
        <tbody class="bg-white divide-y divide-[#EBEFF1]">
          @forelse ($contests as $contest)
            <tr>
              ...
              <td class="px-6 whitespace-nowrap">
                <button href="{{ route('admin.participants.group', $contest) }}" wire:navigate class="text-[13px] gap-x-2 leading-4 text-[#3A4551] py-1 px-2 bg-white border border-[#EBEFF1] rounded-md hover:bg-gray-100 focus:outline-none items-center flex">
                  <ion-icon name="people-outline" class="w-[16px] h-[16px]" wire:ignore></ion-icon>
