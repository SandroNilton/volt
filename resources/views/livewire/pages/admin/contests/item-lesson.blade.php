<div>
      ...
      <div>
        ...
        @else
          <div class="border border-[#EBEFF1] px-3 p-2 text-[13px] leading-4 space-y-1.5 rounded">
            ...
            <p><span class="text-[#3A4551] mr-2">Valor minimo:</span>{{ $item->min }}</p>
            <p><span class="text-[#3A4551] mr-2">Valor maximo:</span>{{ $item->max }}</p>
  ...
  <div x-data="{open: false}" class="mt-4 mb-4">
    ...
    <article class="border border-[#EBEFF1] p-3 rounded" x-show="open">
      <p class="mb-3 text-[13px] leading-4 text-[#3A4551]text-center">Agregar nueva lección</p>
      <div class="mb-3 space-y-1">
        ...
        <div>
          <x-input-label for="min" :value="__('Valor minimo')" />
        ...
        <div>
          <x-input-label for="max" :value="__('Valor maximo')" />
